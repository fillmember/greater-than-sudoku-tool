import { parse, matchFromListSyntax, groupToCombination } from "./parse";
...
describe.only("groupToCombination", () => {
  it("simple ref : different line", () => {
    expect(groupToCombination("REF(B4.0,B5.0)", { B4: [[[3, 4]], [[3, 5]]], B5: [[[1]], [[2]]] })).toStrictEqual([
      [3, 4, 1],
      [3, 4, 2],
      [3, 5, 1],
      [3, 5, 2],
  ...
  it("simple ref : same line", () => {
    expect(
      groupToCombination("REF(B4.0,B4.2)", {
        B4: [
          [[3, 4], [1], [9]],
          [[3, 4], [2], [9]],
          [[3, 5], [1], [9]],
  ...
  it("nested refs : same line", () => {
    expect(
      groupToCombination("REF(B4.0,K(1,REF(B4.2)))", {
        B4: [
          [[3, 4], [1], [9, 6]],
          [[3, 4], [2], [9, 5]],
          [[3, 5], [1], [9, 4]],
